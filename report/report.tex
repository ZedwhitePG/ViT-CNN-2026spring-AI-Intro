...
\begin{titlepage}
    ...
    \begin{tabularx}{0.9\textwidth}{c|X}
        ...
        \hline
        刘梵佑 & 主导实验调度、可视化与报告撰写。负责编写自动化实验脚本，实现 Attention Map 提取及图表生成。 \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l|c|ccc}
        ...
        (ResNet-18)  & 20\%  & 79.89\% & 0.7986 & 24.53 \\
...
\begin{itemize}
    \item \textbf{颜色编码（架构区别）}：蓝色系代表 CNN（ResNet-18），橙/红色系代表 ViT。
...
得益于项目前期的顺利推进，我们在第 5-6 周已超额完成了核心架构的搭建与全部三档数据比例（10\%、20\%、100\%）的模型训练。因此，期末最终报告前的重点将从“跑通基线”全面转向“深度特性分析”与“工程化收尾”。具体进度安排调整如下：
